...
function convert_background_image_dimensions_to_pixels(background_image){
    ...
    case "contain":
      image_dimensions = calculate_containing_image_dimensions(background_image)
      break;
    case "cover":
	...
	let style = zoom_container.value.style
	let width = image_dimensions.image_width
	let height = image_dimensions.image_height
	let distance_top = image_dimensions.top
	let distance_left = image_dimensions.left
...
function calculate_zooming(cursor_absolute_position,in_out){
  ...
  resized_dimensions = resize_dimensions(cursor_absolute_position,in_out)
	...
	let style = zoom_container.value.style
	let new_width = resized_dimensions.image_width
	let new_height = resized_dimensions.image_height
	let new_distance_top = resized_dimensions.top
	let new_distance_left = resized_dimensions.left
...
function resize_dimensions(cursor_absolute_position,in_out){
	let container_box = zoom_container.value.getBoundingClientRect()
